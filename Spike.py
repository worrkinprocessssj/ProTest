...
# Configuration
TOKEN = "8101453857:AAEZMm8CSbvMf4LMCeWnGA7HREtfwMtnm10"  # Replace with your Telegram bot token
ADMIN_IDS = {7263607387,869784286}  # Replace with your actual admin user ID(s)
...
async def start_attack(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text(f"🚀 Attack started on {target_ip}:{target_port}. PAID BOT BY @INFLICT_BGMI")
...
async def stop_attack(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("🛑 Attack stopped successfully. PAID BOT BY @INFLICT_BGMI")
...
async def reset(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    target_ip = None
    target_port = None
    await update.message.reply_text("🔄 Attack settings reset. Please provide new target and port. PAID BOT BY @INFLICT_BGMI")
